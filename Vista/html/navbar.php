<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="index.php?accion=dashboard">Hestia</a><button class="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#"><i class="fas fa-bars"></i></button
            ><!-- Navbar Search-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="index.php?accion=dashboard"
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                ...
                                <a class="nav-link" href="programacionMesas">Programacion de Mesas</a>
                                <a class="nav-link" href="turnos">Turnos</a>
                                <a class="nav-link" href="ingredientes">Ingredientes</a>
                                <a class="nav-link" href="ingrexpro">Ingrediente por Producto</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <a class="nav-link" href="bitacoraCocina">Bitácora Cocina</a>
                                    <a class="nav-link" href="mesero">Mesero</a>
                                </nav>
                            </div>
                        </div>
                    </div>
